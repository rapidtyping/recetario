...
SECRET_KEY = '#tqqik4kb+kszclo)g!_s+*61hmqwf$5kog_h344h=k)(h!9()'
...
#   os.path.join(RUTA_PROYECTO, '../templates')
    os.path.join(RUTA_PROYECTO, '../recetario/plantillas')
...
# Configuraciones para enviar mensajes usango gmail
EMAIL_USE_TLS = True
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_HOST_USER = 'remitente@gmail.com' # cuenta que enviará el mensaje
